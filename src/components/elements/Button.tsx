...
export const Button: React.FC<ButtonProps> = ({
  ...
  const defaultStyle =
    "font-semibold rounded-lg flex justify-center items-center px-4 py-2 gap-2";
  const variants = {
    primary:
      "border border-primary dark:border-white dark:border-white hover:dark:border-primary text-slate-800 hover:border-primary hover:text-white dark:text-white hover:bg-primary",
    secondary:
